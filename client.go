...
// library. It uses a small cache based on the ion/context.StaticCacheDuration.
...
var websocketMessagePrefix = "ion-websocket-message:";
...
var Ws = (function () {
    ...
    Ws.prototype.decodeMessage = function (event, websocketMessage) {
        //ion-websocket-message;user;4;themarshaledstringfromajsonstruct
    ...
    //
    // remember ion gives you the freedom of native websocket messages if you don't want to use this client side at all.
    ...
    // Emit sends an ion-custom websocket message
